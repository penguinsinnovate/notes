...
- 薪资范围：20k~40k
- 职位描述：
  - 开发实时Object Detection, Action Classification等算法；
  - 学习最新人工智能技术，并产品化。

- 任职要求：
  - 熟悉Caffe2、Mxnet、TensorFlow等深度学习框架之一；
  - 扎实的C/C++和Python开发、调试的经验。

- 优先考虑：
  - 在ICCV、CVPR、ECCV发表过论文优先；
  - 研究生博士优先。
